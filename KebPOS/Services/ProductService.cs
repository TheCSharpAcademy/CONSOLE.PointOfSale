...
public class ProductService
{
    public static void InsertProduct()
    {
        ...
        while (inOption)
        {
            ...
            product.Description = AnsiConsole.Ask<string>("Product's description");
            duplicate = Validation.CheckProductDuplicate(product);
            ...
            inOption = AnsiConsole.Ask<bool>("Enter New Product?");
        }
    }
